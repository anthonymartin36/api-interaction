$(document).ready(function() {
  ...
  function generate(){
    ...
    //       var $title = $('<span>').text(data.talks[0].source);
    //       var $translation = $('<span>').text(data.talks[0].translation);
    //       $('#quote')
    //          .append($title)
    //          .append($translation);
    //    },
